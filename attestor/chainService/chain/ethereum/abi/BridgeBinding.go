...
// SayHello is a free data retrieval call binding the contract method 0xef5fb05b.
//
// Solidity: function sayHello() pure returns(string)
func (_Bridge *BridgeCaller) SayHello(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Bridge.contract.Call(opts, &out, "sayHello")
...
//
// Solidity: function sayHello() pure returns(string)
func (_Bridge *BridgeSession) SayHello() (string, error) {
	return _Bridge.Contract.SayHello(&_Bridge.CallOpts)
}

// SayHello is a free data retrieval call binding the contract method 0xef5fb05b.
//
// Solidity: function sayHello() pure returns(string)
func (_Bridge *BridgeCallerSession) SayHello() (string, error) {
	return _Bridge.Contract.SayHello(&_Bridge.CallOpts)
}
