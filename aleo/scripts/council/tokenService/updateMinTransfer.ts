...
import { TsAddToken, TsUpdateMinTransfer } from "../../../artifacts/js/types/token_service_council";
import { getTsAddTokenLeo, getTsUpdateMinTransferLeo } from "../../../artifacts/js/js2leo/token_service_council";
...
export const execUpdateMinTransfer = async (
  ...
  const [updateMinTransferTx] = await serviceCouncil.ts_update_min_transfer(
