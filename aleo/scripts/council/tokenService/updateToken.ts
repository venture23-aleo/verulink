...
import { SetRoleForToken, UpdateTokenMetadata } from "../../../artifacts/js/types/vlink_token_service_council_v07";
import { getSetRoleForTokenLeo, getUpdateTokenMetadataLeo, } from "../../../artifacts/js/js2leo/vlink_token_service_council_v07";
