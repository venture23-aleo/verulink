import { TransferOwnershipHolding } from "../../../artifacts/js/types/vlink_token_service_council_v07";
...
import { getTransferOwnershipHolding } from "../../../artifacts/js/leo2js/vlink_token_service_council_v07";
import { getTransferOwnershipHoldingLeo } from "../../../artifacts/js/js2leo/vlink_token_service_council_v07";
...
const holding = new Vlink_holding_v7Contract({ mode, priorityFee: 10_000 });
