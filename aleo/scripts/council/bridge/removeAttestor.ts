...
import { getTbRemoveAttestorLeo } from "../../../artifacts/js/js2leo/vlink_bridge_council_v07";
import { TbRemoveAttestor } from "../../../artifacts/js/types/vlink_bridge_council_v07";
