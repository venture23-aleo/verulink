...
import { InPacket, InPacketWithScreening } from '../artifacts/js/types/vlink_token_bridge_v7';
import { getInPacketLeo, getInPacketWithScreeningLeo } from '../artifacts/js/js2leo/vlink_token_bridge_v7';
