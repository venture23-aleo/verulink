...
import { getProposalVoteLeo } from "../artifacts/js/js2leo/council_dev_v2";
import { ProposalVote, ProposalVoterKey } from "../artifacts/js/types/council_dev_v2";
import { ALEO_ZERO_ADDRESS } from "./constants";
import { hashStruct } from "./hash";
import { ExecutionMode } from "@doko-js/core";

const mode = ExecutionMode.SnarkExecute;
const council = new Council_dev_v2Contract({ mode });
