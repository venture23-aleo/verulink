...
| Name             | Remarks                                                                           |
|------------------|-----------------------------------------------------------------------------------|
| Denom            | The field represents the type/id of token we are dealing with like “USDT” or “wUSDT” |
...
- * Max Limits On Withdrawls*: Token specific limits will be defined on token service contract to disable withdrawal of large funds in a single transaction. Such withdrawals can only be completed by intervention from the council multisig.
