...
async function proposeUpgradeTokenService(signer) {
  ...
  const deployCallData = deployerInterface.encodeFunctionData("upgradeTo", [tokenservicenewImplementationAddress]);
...
(async () => {
  try {
    ...
    console.log("TokenService upgraded successfully!");
  } catch (error) {
