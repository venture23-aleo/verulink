...
async function proposePauseBridgeTransaction(signer) {
...
(async () => {
  try {
    ...
    const safeTxHash = await proposePauseBridgeTransaction(deployerSigner);
    ...
    console.log("Bridge contract paused successfully!");
  } catch (error) {
