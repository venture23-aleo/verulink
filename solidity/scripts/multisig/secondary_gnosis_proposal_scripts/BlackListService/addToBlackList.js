...
async function proposeAddToBlackListTransaction(signer) {
...
(async () => {
  try {
    ...
    const safeTxHash = await proposeAddToBlackListTransaction(deployerSigner);
    ...
    console.log("Account successfully added to the blacklist!");
  } catch (error) {
