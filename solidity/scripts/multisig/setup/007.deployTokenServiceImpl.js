...
(async () => {
    try {
        ...
        updateEnvFile("TOKENSERVICEIMPLEMENTATION_ADDRESS", ethers.utils.getAddress(trimmedAddress));
        console.log("TOKENSERVICEIMPLEMENTATION Contract Address:", ethers.utils.getAddress(trimmedAddress));
    } catch (error) {
