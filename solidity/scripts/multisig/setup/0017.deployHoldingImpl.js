...
(async () => {
    try {
        ...
        updateEnvFile("HOLDINGIMPLEMENTATION_ADDRESS", ethers.utils.getAddress(trimmedAddress));
        console.log("HOLDINGIMPLEMENTATION Contract Address:", ethers.utils.getAddress(trimmedAddress));
    } catch (error) {
