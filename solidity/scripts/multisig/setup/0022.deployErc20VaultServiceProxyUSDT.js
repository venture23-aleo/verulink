...
(async () => {
    try {
        ...
        updateEnvFile("ERC20VAULTSERVICEPROXY_ADDRESS_USDT", ethers.utils.getAddress(trimmedAddress));
        console.log("ERC20VAULTSERVICEPROXY_USDT Contract Address:", ethers.utils.getAddress(trimmedAddress));
    } catch (error) {
