...
async function enableToken(signer) {
  ...
  const calldata = iface.encodeFunctionData("enable", [tokenAddress, destChainId]);
...
enableToken(new ethers.Wallet(process.env.SECRET_KEY1, provider));