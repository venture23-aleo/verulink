...
# npx hardhat run scripts/deploy/removeAttestor.js --network sepolia
...
# npx hardhat run scripts/deploy/deployETHVaultService.js --network holesky
# npx hardhat run scripts/deploy/addTokenService.js --network holesky
# npx hardhat run scripts/deploy/setHolding.js --network holesky
# npx hardhat run scripts/deploy/addTokenUSDC.js --network holesky
# npx hardhat run scripts/deploy/addTokenUSDT.js --network holesky
# npx hardhat run scripts/deploy/addTokenETH.js --network holesky
# npx hardhat run scripts/deploy/addAttestor.js --network holesky
# npx hardhat run scripts/deploy/removeAttestor.js --network holesky
# npx hardhat run scripts/deploy/transferOwnerShipBridge.js --network holesky
# npx hardhat run scripts/deploy/transferOwnerShipBlackListService.js --network holesky
# npx hardhat run scripts/deploy/transferOwnershipTokenservice.js --network holesky
...
# npx hardhat run scripts/deploy/setFeeCollectorAddress.js --network holesky
...
# npx hardhat run scripts/deploy/deployTokenServiceV2Impl.js --network base-sepolia
...
# npx hardhat run scripts/deploy/deployFeeCollector.js --network base-sepolia
# npx hardhat run scripts/deploy/setFeeCollectorAddress.js --network base-sepolia
